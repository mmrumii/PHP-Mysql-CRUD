	  	...
	  	<div class="container py-5">
			...
			<div class="row">
				<div class="col-6 p-4">
					...
					<form class="py-5" method="post" action="add_domain.php">


					  <div class="form-group">
					    <label for="exampleInputEmail1">Domain</label>
					    <input type="text" class="form-control" name="domain" id="exampleInputEmail1" aria-describedby="emailHelp">
                ...
                <th scope="col">Action</th>
					  ...
					  <tbody>
  					    ...
  					    <tr>
					        ...
					        <td>
                    <form method="post" action="delete_domain.php">
                        <input type="number" name="domain_id" value="<?php echo htmlspecialchars($row["id"]); ?>" hidden />
